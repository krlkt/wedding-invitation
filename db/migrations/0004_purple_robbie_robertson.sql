DROP INDEX IF EXISTS "bride_section_content_wedding_config_id_unique";--> statement-breakpoint
DROP INDEX IF EXISTS "bank_details_wedding_config_id_unique";--> statement-breakpoint
DROP INDEX IF EXISTS "dress_codes_wedding_config_id_unique";--> statement-breakpoint
DROP INDEX IF EXISTS "groom_section_content_wedding_config_id_unique";--> statement-breakpoint
DROP INDEX IF EXISTS "user_accounts_email_unique";--> statement-breakpoint
DROP INDEX IF EXISTS "wedding_configurations_user_id_unique";--> statement-breakpoint
DROP INDEX IF EXISTS "wedding_configurations_subdomain_unique";--> statement-breakpoint
DROP INDEX IF EXISTS "starting_section_content_wedding_config_id_unique";--> statement-breakpoint
