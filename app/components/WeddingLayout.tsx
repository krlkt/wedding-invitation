    ...
    return (
        <div className="wedding-layout">
            ...
            <footer className="py-8 text-center bg-gray-50">
                ...
                {wedding.footerText && <p className="text-gray-600 text-sm">{wedding.footerText}</p>}
                <p className="text-gray-400 text-xs mt-2">Created with ❤️ using Wedding Invitation Platform</p>
            </footer>
        </div>
    );
}
