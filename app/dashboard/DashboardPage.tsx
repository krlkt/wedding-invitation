...
import { TextField, Button, Box, Stack, FormControl, InputLabel, Select, MenuItem, Typography, IconButton, Tooltip } from '@mui/material';
...
const DashboardPage = () => {
    ...
    const handleImport = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        reader.onload = async (evt) => {
            ...
            enqueueSnackbar('Data was imported successfully', { variant: 'success' });
