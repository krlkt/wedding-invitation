...
export const ManageTablesModal: FC<ManageTablesModalProps> = ({
  ...
  return (
    <Modal open={open} onClose={onClose}>
      <div className="p-4">
        <h2 className="mb-4 text-2xl font-bold">Manage Tables</h2>
        <div className="space-y-4">
          ...
          <div className="h-[calc(100vh-10rem)] space-y-2 overflow-auto">
                ...
                {editingTableId === table.id ? (
                  <div className="flex flex-grow items-center space-x-2">
                    ...
                    <TextField
                      ...
                      size="small"
                    />
                    <Button onClick={() => handleSave(table.id)} variant="contained" size="small">
                      Save
                    </Button>
                  ...
                  <>
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {table.guests.length} / {table.max_guests} guests
                      </p>
                    </div>
