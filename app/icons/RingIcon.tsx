...
const RingIcon = () => (
    ...
    >
        ...
        ></path>
        <path
            d="M32 23.108c-9.457 0-17.152 7.784-17.152 17.351c0 9.568 7.695 17.352 17.152 17.352s17.152-7.783 17.152-17.352c0-9.567-7.695-17.351-17.152-17.351m0 32.767c-8.391 0-15.217-6.916-15.217-15.416S23.61 25.043 32 25.043s15.216 6.916 15.216 15.416S40.391 55.875 32 55.875"
            fill={secondaryColorHex}
        ></path>
    </svg>
);
