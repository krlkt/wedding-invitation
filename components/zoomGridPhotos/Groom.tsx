      ...
      >
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
          <motion.div style={{ opacity: textOpacityGroom }} className="h-[230px] w-[340px]">
            {/* Background box */}
            <div className="absolute inset-x-6 inset-y-3 z-0 rounded-lg bg-black/50 p-6" />

            {/* Text layer */}
            <div className="absolute inset-x-10 inset-y-16 z-20 flex flex-col items-center justify-center gap-2 text-white">
              <motion.h2
              ...
              >
                <span className="inline-flex items-center gap-2">
                  ...
                  {features.groom_and_bride === true &&
                    groomSection?.groomInstagramLink &&
                    groomSection?.showInstagramLink && (
                      <a
                        href={groomSection.groomInstagramLink}
                        target="_blank"
