...
const DashboardClientPage = ({
        ...
        <GridActionsCellItem
          ...
          icon={
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="h-6 w-6 cursor-pointer text-red-500 transition-colors hover:text-red-700"
            >
  ...
  return (
    <Box p={2}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: 16 }}>
        Wedding Participants Dashboard
      </h1>
        ...
        <Box textAlign="right">
          ...
          <Typography variant="h6" sx={{ fontWeight: 'bold' }}>
            ...
            {data
              .filter(
                (p) =>
                  p.attend?.toLowerCase() !== 'yes' &&
                  p.attend?.toLowerCase() !== 'no' &&
                  !p.possibly_not_coming
              )
